...
const SubscriptionTemplate = () => {
  return (
    <div className="absolute top-[-220px] md:top-[-320px] w-full h-60 bg-white bg-opacity-10 rounded-2xl mt-5 md:mt-48 flex items-center justify-center py-10 md:py-12 px-5 md:px-5 backdrop-blur-lg">
      <div className="">
        <h6 className="text-center font-medium text-[18px] md:text-[40px]">
        Join Our Waiting List
        </h6>
        <p className="text-sm md:text-[18px] text-center pb-5 pt-2 text-white text-opacity-70 md:px-10 font-extralight leading-tight">
